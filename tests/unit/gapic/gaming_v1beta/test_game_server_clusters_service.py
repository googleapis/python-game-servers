...
async def test_list_game_server_clusters_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_game_server_clusters(
            request={},
        )
...
def test_list_game_server_clusters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*/realms/*}/gameServerClusters"
...
def test_get_game_server_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/realms/*/gameServerClusters/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_game_server_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{game_server_cluster.name=projects/*/locations/*/realms/*/gameServerClusters/*}"
            % client.transport._host,
            args[1],
        )
