...
from google.cloud.gaming_v1beta.types import common, realms
...
def test_realms_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_list_realms_rest_required_fields(request_type=realms.ListRealmsRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_realms._get_unset_required_fields(jsonified_request)
...
def test_list_realms_rest_interceptors(null_interceptor):
    transport = transports.RealmsServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.RealmsServiceRestInterceptor(),
    )
    ...
    with mock.patch.object(
        ...
        transports.RealmsServiceRestInterceptor, "post_list_realms"
    ) as post, mock.patch.object(
        transports.RealmsServiceRestInterceptor, "pre_list_realms"
    ) as pre:
        ...
        req.return_value._content = realms.ListRealmsResponse.to_json(
            realms.ListRealmsResponse()
        )
...
def test_list_realms_rest_bad_request(
    transport: str = "rest", request_type=realms.ListRealmsRequest
):
    client = RealmsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_realms_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*}/realms" % client.transport._host,
            args[1],
        )
...
def test_get_realm_rest_required_fields(request_type=realms.GetRealmRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_realm._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_realm_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.RealmsServiceRestInterceptor, "post_get_realm"
    ) as post, mock.patch.object(
        transports.RealmsServiceRestInterceptor, "pre_get_realm"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_realm_rest_bad_request(
    transport: str = "rest", request_type=realms.GetRealmRequest
):
    client = RealmsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_realm_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/realms/*}" % client.transport._host,
            args[1],
        )
...
def test_create_realm_rest_required_fields(request_type=realms.CreateRealmRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_realm._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_realm_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.RealmsServiceRestInterceptor, "post_create_realm"
    ) as post, mock.patch.object(
        transports.RealmsServiceRestInterceptor, "pre_create_realm"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_realm_rest_bad_request(
    transport: str = "rest", request_type=realms.CreateRealmRequest
):
    client = RealmsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_delete_realm_rest_required_fields(request_type=realms.DeleteRealmRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_realm._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_realm_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.RealmsServiceRestInterceptor, "post_delete_realm"
    ) as post, mock.patch.object(
        transports.RealmsServiceRestInterceptor, "pre_delete_realm"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_realm_rest_bad_request(
    transport: str = "rest", request_type=realms.DeleteRealmRequest
):
    client = RealmsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_update_realm_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {
        "realm": {"name": "projects/sample1/locations/sample2/realms/sample3"}
    }
    request_init["realm"] = {
        "name": "projects/sample1/locations/sample2/realms/sample3",
        "create_time": {"seconds": 751, "nanos": 543},
        "update_time": {},
        "labels": {},
        "time_zone": "time_zone_value",
...
def test_update_realm_rest_required_fields(request_type=realms.UpdateRealmRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).update_realm._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_realm_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.RealmsServiceRestInterceptor, "post_update_realm"
    ) as post, mock.patch.object(
        transports.RealmsServiceRestInterceptor, "pre_update_realm"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_realm_rest_bad_request(
    transport: str = "rest", request_type=realms.UpdateRealmRequest
):
    client = RealmsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_update_realm_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{realm.name=projects/*/locations/*/realms/*}"
...
def test_preview_realm_update_rest_required_fields(
    request_type=realms.PreviewRealmUpdateRequest,
):
    transport_class = transports.RealmsServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).preview_realm_update._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_preview_realm_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.RealmsServiceRestInterceptor, "post_preview_realm_update"
    ) as post, mock.patch.object(
        transports.RealmsServiceRestInterceptor, "pre_preview_realm_update"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = realms.PreviewRealmUpdateRequest.pb(
            realms.PreviewRealmUpdateRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = realms.PreviewRealmUpdateResponse.to_json(
            realms.PreviewRealmUpdateResponse()
        )
...
def test_preview_realm_update_rest_bad_request(
    transport: str = "rest", request_type=realms.PreviewRealmUpdateRequest
):
    client = RealmsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
