...
def test_game_server_deployments_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_list_game_server_deployments_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        pb_return_value = game_server_deployments.ListGameServerDeploymentsResponse.pb(
            return_value
        )
...
def test_list_game_server_deployments_rest_required_fields(
    request_type=game_server_deployments.ListGameServerDeploymentsRequest,
):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_game_server_deployments._get_unset_required_fields(jsonified_request)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            pb_return_value = (
                game_server_deployments.ListGameServerDeploymentsResponse.pb(
                    return_value
                )
            )
            json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_game_server_deployments_rest_interceptors(null_interceptor):
    transport = transports.GameServerDeploymentsServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.GameServerDeploymentsServiceRestInterceptor(),
    )
    ...
    with mock.patch.object(
        ...
        transports.GameServerDeploymentsServiceRestInterceptor,
        "post_list_game_server_deployments",
    ) as post, mock.patch.object(
        transports.GameServerDeploymentsServiceRestInterceptor,
        "pre_list_game_server_deployments",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_deployments.ListGameServerDeploymentsRequest.pb(
            game_server_deployments.ListGameServerDeploymentsRequest()
        )
        ...
        req.return_value._content = (
            game_server_deployments.ListGameServerDeploymentsResponse.to_json(
                game_server_deployments.ListGameServerDeploymentsResponse()
            )
        )
...
def test_list_game_server_deployments_rest_bad_request(
    transport: str = "rest",
    request_type=game_server_deployments.ListGameServerDeploymentsRequest,
):
    client = GameServerDeploymentsServiceClient(
...
def test_list_game_server_deployments_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            game_server_deployments.ListGameServerDeploymentsResponse.to_json(x)
            for x in response
        )
...
def test_get_game_server_deployment_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {
        "name": "projects/sample1/locations/sample2/gameServerDeployments/sample3"
    }
    request = request_type(**request_init)
...
def test_get_game_server_deployment_rest_required_fields(
    request_type=game_server_deployments.GetGameServerDeploymentRequest,
):
    transport_class = transports.GameServerDeploymentsServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_game_server_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            pb_return_value = game_server_deployments.GameServerDeployment.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_game_server_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.GameServerDeploymentsServiceRestInterceptor,
        "post_get_game_server_deployment",
    ) as post, mock.patch.object(
        transports.GameServerDeploymentsServiceRestInterceptor,
        "pre_get_game_server_deployment",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_deployments.GetGameServerDeploymentRequest.pb(
            game_server_deployments.GetGameServerDeploymentRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.request = PreparedRequest()
        req.return_value._content = (
            game_server_deployments.GameServerDeployment.to_json(
                game_server_deployments.GameServerDeployment()
            )
        )
...
def test_get_game_server_deployment_rest_bad_request(
    transport: str = "rest",
    request_type=game_server_deployments.GetGameServerDeploymentRequest,
):
    client = GameServerDeploymentsServiceClient(
...
def test_create_game_server_deployment_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request_init["game_server_deployment"] = {
        "name": "name_value",
...
def test_create_game_server_deployment_rest_required_fields(
    request_type=game_server_deployments.CreateGameServerDeploymentRequest,
):
    transport_class = transports.GameServerDeploymentsServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_game_server_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_game_server_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.GameServerDeploymentsServiceRestInterceptor,
        "post_create_game_server_deployment",
    ) as post, mock.patch.object(
        transports.GameServerDeploymentsServiceRestInterceptor,
        "pre_create_game_server_deployment",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_deployments.CreateGameServerDeploymentRequest.pb(
            game_server_deployments.CreateGameServerDeploymentRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_create_game_server_deployment_rest_bad_request(
    transport: str = "rest",
    request_type=game_server_deployments.CreateGameServerDeploymentRequest,
):
    client = GameServerDeploymentsServiceClient(
...
def test_delete_game_server_deployment_rest_required_fields(
    request_type=game_server_deployments.DeleteGameServerDeploymentRequest,
):
    transport_class = transports.GameServerDeploymentsServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_game_server_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_game_server_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.GameServerDeploymentsServiceRestInterceptor,
        "post_delete_game_server_deployment",
    ) as post, mock.patch.object(
        transports.GameServerDeploymentsServiceRestInterceptor,
        "pre_delete_game_server_deployment",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_deployments.DeleteGameServerDeploymentRequest.pb(
            game_server_deployments.DeleteGameServerDeploymentRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_delete_game_server_deployment_rest_bad_request(
    transport: str = "rest",
    request_type=game_server_deployments.DeleteGameServerDeploymentRequest,
):
    client = GameServerDeploymentsServiceClient(
...
def test_update_game_server_deployment_rest_required_fields(
    request_type=game_server_deployments.UpdateGameServerDeploymentRequest,
):
    transport_class = transports.GameServerDeploymentsServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).update_game_server_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_game_server_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.GameServerDeploymentsServiceRestInterceptor,
        "post_update_game_server_deployment",
    ) as post, mock.patch.object(
        transports.GameServerDeploymentsServiceRestInterceptor,
        "pre_update_game_server_deployment",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_deployments.UpdateGameServerDeploymentRequest.pb(
            game_server_deployments.UpdateGameServerDeploymentRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_update_game_server_deployment_rest_bad_request(
    transport: str = "rest",
    request_type=game_server_deployments.UpdateGameServerDeploymentRequest,
):
    client = GameServerDeploymentsServiceClient(
...
def test_get_game_server_deployment_rollout_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = game_server_deployments.GameServerDeploymentRollout.pb(
            return_value
        )
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_game_server_deployment_rollout_rest_required_fields(
    request_type=game_server_deployments.GetGameServerDeploymentRolloutRequest,
):
    transport_class = transports.GameServerDeploymentsServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_game_server_deployment_rollout._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_game_server_deployment_rollout_rest_unset_required_fields():
    ...
    unset_fields = (
        transport.get_game_server_deployment_rollout._get_unset_required_fields({})
    )
    assert set(unset_fields) == (set(()) & set(("name",)))
...
def test_get_game_server_deployment_rollout_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.GameServerDeploymentsServiceRestInterceptor,
        "post_get_game_server_deployment_rollout",
    ) as post, mock.patch.object(
        transports.GameServerDeploymentsServiceRestInterceptor,
        "pre_get_game_server_deployment_rollout",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_deployments.GetGameServerDeploymentRolloutRequest.pb(
            game_server_deployments.GetGameServerDeploymentRolloutRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.request = PreparedRequest()
        req.return_value._content = (
            game_server_deployments.GameServerDeploymentRollout.to_json(
                game_server_deployments.GameServerDeploymentRollout()
            )
        )
...
def test_get_game_server_deployment_rollout_rest_bad_request(
    transport: str = "rest",
    request_type=game_server_deployments.GetGameServerDeploymentRolloutRequest,
):
    client = GameServerDeploymentsServiceClient(
...
def test_update_game_server_deployment_rollout_rest(request_type):
    ...
    request_init["rollout"] = {
        ...
        "game_server_config_overrides": [
            {
                "realms_selector": {"realms": ["realms_value1", "realms_value2"]},
...
def test_update_game_server_deployment_rollout_rest_required_fields(
    request_type=game_server_deployments.UpdateGameServerDeploymentRolloutRequest,
):
    transport_class = transports.GameServerDeploymentsServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).update_game_server_deployment_rollout._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_game_server_deployment_rollout_rest_unset_required_fields():
    ...
    unset_fields = (
        transport.update_game_server_deployment_rollout._get_unset_required_fields({})
    )
    assert set(unset_fields) == (
        set(("updateMask",))
        & set(
...
def test_update_game_server_deployment_rollout_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.GameServerDeploymentsServiceRestInterceptor,
        "post_update_game_server_deployment_rollout",
    ) as post, mock.patch.object(
        transports.GameServerDeploymentsServiceRestInterceptor,
        "pre_update_game_server_deployment_rollout",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = (
...
def test_update_game_server_deployment_rollout_rest_bad_request(
    transport: str = "rest",
    request_type=game_server_deployments.UpdateGameServerDeploymentRolloutRequest,
):
    client = GameServerDeploymentsServiceClient(
...
def test_preview_game_server_deployment_rollout_rest_required_fields(
    request_type=game_server_deployments.PreviewGameServerDeploymentRolloutRequest,
):
    transport_class = transports.GameServerDeploymentsServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).preview_game_server_deployment_rollout._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_preview_game_server_deployment_rollout_rest_unset_required_fields():
    ...
    unset_fields = (
        transport.preview_game_server_deployment_rollout._get_unset_required_fields({})
    )
    assert set(unset_fields) == (
        set(
            (
...
def test_preview_game_server_deployment_rollout_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.GameServerDeploymentsServiceRestInterceptor,
        "post_preview_game_server_deployment_rollout",
    ) as post, mock.patch.object(
        transports.GameServerDeploymentsServiceRestInterceptor,
        "pre_preview_game_server_deployment_rollout",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = (
        ...
        req.return_value.request = PreparedRequest()
        req.return_value._content = (
            game_server_deployments.PreviewGameServerDeploymentRolloutResponse.to_json(
                game_server_deployments.PreviewGameServerDeploymentRolloutResponse()
            )
        )
...
def test_preview_game_server_deployment_rollout_rest_bad_request(
    transport: str = "rest",
    request_type=game_server_deployments.PreviewGameServerDeploymentRolloutRequest,
):
    client = GameServerDeploymentsServiceClient(
...
def test_fetch_deployment_state_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = game_server_deployments.FetchDeploymentStateResponse.pb(
            return_value
        )
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_fetch_deployment_state_rest_required_fields(
    request_type=game_server_deployments.FetchDeploymentStateRequest,
):
    transport_class = transports.GameServerDeploymentsServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).fetch_deployment_state._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_deployment_state_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.GameServerDeploymentsServiceRestInterceptor,
        "post_fetch_deployment_state",
    ) as post, mock.patch.object(
        transports.GameServerDeploymentsServiceRestInterceptor,
        "pre_fetch_deployment_state",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_deployments.FetchDeploymentStateRequest.pb(
            game_server_deployments.FetchDeploymentStateRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.request = PreparedRequest()
        req.return_value._content = (
            game_server_deployments.FetchDeploymentStateResponse.to_json(
                game_server_deployments.FetchDeploymentStateResponse()
            )
        )
...
def test_fetch_deployment_state_rest_bad_request(
    transport: str = "rest",
    request_type=game_server_deployments.FetchDeploymentStateRequest,
):
    client = GameServerDeploymentsServiceClient(
...
def test_game_server_deployments_service_client_transport_session_collision(
    transport_name,
):
