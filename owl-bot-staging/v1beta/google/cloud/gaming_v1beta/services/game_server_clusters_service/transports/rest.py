...
from .base import GameServerClustersServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class GameServerClustersServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_game_server_cluster(self, request: game_server_clusters.CreateGameServerClusterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[game_server_clusters.CreateGameServerClusterRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_game_server_cluster(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_delete_game_server_cluster(self, request: game_server_clusters.DeleteGameServerClusterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[game_server_clusters.DeleteGameServerClusterRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_delete_game_server_cluster(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_get_game_server_cluster(self, request: game_server_clusters.GetGameServerClusterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[game_server_clusters.GetGameServerClusterRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_game_server_cluster(self, response: game_server_clusters.GameServerCluster) -> game_server_clusters.GameServerCluster:
        ...
        """
        return response
    def pre_list_game_server_clusters(self, request: game_server_clusters.ListGameServerClustersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[game_server_clusters.ListGameServerClustersRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_game_server_clusters(self, response: game_server_clusters.ListGameServerClustersResponse) -> game_server_clusters.ListGameServerClustersResponse:
        ...
        """
        return response
    def pre_preview_create_game_server_cluster(self, request: game_server_clusters.PreviewCreateGameServerClusterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[game_server_clusters.PreviewCreateGameServerClusterRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_preview_create_game_server_cluster(self, response: game_server_clusters.PreviewCreateGameServerClusterResponse) -> game_server_clusters.PreviewCreateGameServerClusterResponse:
        ...
        """
        return response
    def pre_preview_delete_game_server_cluster(self, request: game_server_clusters.PreviewDeleteGameServerClusterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[game_server_clusters.PreviewDeleteGameServerClusterRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_preview_delete_game_server_cluster(self, response: game_server_clusters.PreviewDeleteGameServerClusterResponse) -> game_server_clusters.PreviewDeleteGameServerClusterResponse:
        ...
        """
        return response
    def pre_preview_update_game_server_cluster(self, request: game_server_clusters.PreviewUpdateGameServerClusterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[game_server_clusters.PreviewUpdateGameServerClusterRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_preview_update_game_server_cluster(self, response: game_server_clusters.PreviewUpdateGameServerClusterResponse) -> game_server_clusters.PreviewUpdateGameServerClusterResponse:
        ...
        """
        return response
    def pre_update_game_server_cluster(self, request: game_server_clusters.UpdateGameServerClusterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[game_server_clusters.UpdateGameServerClusterRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_update_game_server_cluster(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
...
class GameServerClustersServiceRestTransport(GameServerClustersServiceTransport):
    ...
    class _CreateGameServerCluster(GameServerClustersServiceRestStub):
        ...
        cluster method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta/{parent=projects/*/locations/*/realms/*}/gameServerClusters',
                'body': 'game_server_cluster',
            },
            ]
            request, metadata = self._interceptor.pre_create_game_server_cluster(request, metadata)
    ...
    class _DeleteGameServerCluster(GameServerClustersServiceRestStub):
        ...
        cluster method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1beta/{name=projects/*/locations/*/realms/*/gameServerClusters/*}',
            },
            ]
            request, metadata = self._interceptor.pre_delete_game_server_cluster(request, metadata)
    ...
    class _GetGameServerCluster(GameServerClustersServiceRestStub):
        ...
        def __call__(self,
            ...
            request, metadata = self._interceptor.pre_get_game_server_cluster(request, metadata)
    ...
    class _ListGameServerClusters(GameServerClustersServiceRestStub):
        ...
        def __call__(self,
            ...
            request, metadata = self._interceptor.pre_list_game_server_clusters(request, metadata)
    ...
    class _PreviewCreateGameServerCluster(GameServerClustersServiceRestStub):
        ...
        server cluster method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta/{parent=projects/*/locations/*/realms/*}/gameServerClusters:previewCreate',
                'body': 'game_server_cluster',
            },
            ]
            request, metadata = self._interceptor.pre_preview_create_game_server_cluster(request, metadata)
            pb_request = game_server_clusters.PreviewCreateGameServerClusterRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            ...
            pb_resp = game_server_clusters.PreviewCreateGameServerClusterResponse.pb(resp)
    ...
    class _PreviewDeleteGameServerCluster(GameServerClustersServiceRestStub):
        ...
        server cluster method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1beta/{name=projects/*/locations/*/realms/*/gameServerClusters/*}:previewDelete',
            },
            ]
            request, metadata = self._interceptor.pre_preview_delete_game_server_cluster(request, metadata)
            pb_request = game_server_clusters.PreviewDeleteGameServerClusterRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            ...
            pb_resp = game_server_clusters.PreviewDeleteGameServerClusterResponse.pb(resp)
    ...
    class _PreviewUpdateGameServerCluster(GameServerClustersServiceRestStub):
        ...
        server cluster method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1beta/{game_server_cluster.name=projects/*/locations/*/realms/*/gameServerClusters/*}:previewUpdate',
                'body': 'game_server_cluster',
            },
            ]
            request, metadata = self._interceptor.pre_preview_update_game_server_cluster(request, metadata)
            pb_request = game_server_clusters.PreviewUpdateGameServerClusterRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            ...
            pb_resp = game_server_clusters.PreviewUpdateGameServerClusterResponse.pb(resp)
    ...
    class _UpdateGameServerCluster(GameServerClustersServiceRestStub):
        ...
        cluster method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1beta/{game_server_cluster.name=projects/*/locations/*/realms/*/gameServerClusters/*}',
                'body': 'game_server_cluster',
            },
            ]
            request, metadata = self._interceptor.pre_update_game_server_cluster(request, metadata)
...
__all__=(
    'GameServerClustersServiceRestTransport',
)
