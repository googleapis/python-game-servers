...
from .base import GameServerDeploymentsServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class GameServerDeploymentsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_game_server_deployment(self, request: game_server_deployments.CreateGameServerDeploymentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[game_server_deployments.CreateGameServerDeploymentRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_game_server_deployment(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_delete_game_server_deployment(self, request: game_server_deployments.DeleteGameServerDeploymentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[game_server_deployments.DeleteGameServerDeploymentRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_delete_game_server_deployment(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_fetch_deployment_state(self, request: game_server_deployments.FetchDeploymentStateRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[game_server_deployments.FetchDeploymentStateRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_fetch_deployment_state(self, response: game_server_deployments.FetchDeploymentStateResponse) -> game_server_deployments.FetchDeploymentStateResponse:
        ...
        """
        return response
    def pre_get_game_server_deployment(self, request: game_server_deployments.GetGameServerDeploymentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[game_server_deployments.GetGameServerDeploymentRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_game_server_deployment(self, response: game_server_deployments.GameServerDeployment) -> game_server_deployments.GameServerDeployment:
        ...
        """
        return response
    def pre_get_game_server_deployment_rollout(self, request: game_server_deployments.GetGameServerDeploymentRolloutRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[game_server_deployments.GetGameServerDeploymentRolloutRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_game_server_deployment_rollout(self, response: game_server_deployments.GameServerDeploymentRollout) -> game_server_deployments.GameServerDeploymentRollout:
        ...
        """
        return response
    def pre_list_game_server_deployments(self, request: game_server_deployments.ListGameServerDeploymentsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[game_server_deployments.ListGameServerDeploymentsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_game_server_deployments(self, response: game_server_deployments.ListGameServerDeploymentsResponse) -> game_server_deployments.ListGameServerDeploymentsResponse:
        ...
        """
        return response
    def pre_preview_game_server_deployment_rollout(self, request: game_server_deployments.PreviewGameServerDeploymentRolloutRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[game_server_deployments.PreviewGameServerDeploymentRolloutRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_preview_game_server_deployment_rollout(self, response: game_server_deployments.PreviewGameServerDeploymentRolloutResponse) -> game_server_deployments.PreviewGameServerDeploymentRolloutResponse:
        ...
        """
        return response
    def pre_update_game_server_deployment(self, request: game_server_deployments.UpdateGameServerDeploymentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[game_server_deployments.UpdateGameServerDeploymentRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_update_game_server_deployment(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_update_game_server_deployment_rollout(self, request: game_server_deployments.UpdateGameServerDeploymentRolloutRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[game_server_deployments.UpdateGameServerDeploymentRolloutRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_update_game_server_deployment_rollout(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
...
class GameServerDeploymentsServiceRestTransport(GameServerDeploymentsServiceTransport):
    ...
    class _CreateGameServerDeployment(GameServerDeploymentsServiceRestStub):
        ...
        deployment method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta/{parent=projects/*/locations/*}/gameServerDeployments',
                'body': 'game_server_deployment',
            },
            ]
            request, metadata = self._interceptor.pre_create_game_server_deployment(request, metadata)
            pb_request = game_server_deployments.CreateGameServerDeploymentRequest.pb(request)
    ...
    class _DeleteGameServerDeployment(GameServerDeploymentsServiceRestStub):
        ...
        deployment method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1beta/{name=projects/*/locations/*/gameServerDeployments/*}',
            },
            ]
            request, metadata = self._interceptor.pre_delete_game_server_deployment(request, metadata)
            pb_request = game_server_deployments.DeleteGameServerDeploymentRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _FetchDeploymentState(GameServerDeploymentsServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta/{name=projects/*/locations/*/gameServerDeployments/*}:fetchDeploymentState',
                'body': '*',
            },
            ]
            request, metadata = self._interceptor.pre_fetch_deployment_state(request, metadata)
    ...
    class _GetGameServerDeployment(GameServerDeploymentsServiceRestStub):
        ...
        deployment method over HTTP.
            ...
            request, metadata = self._interceptor.pre_get_game_server_deployment(request, metadata)
            pb_request = game_server_deployments.GetGameServerDeploymentRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetGameServerDeploymentRollout(GameServerDeploymentsServiceRestStub):
        ...
        deployment rollout method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1beta/{name=projects/*/locations/*/gameServerDeployments/*}/rollout',
            },
            ]
            request, metadata = self._interceptor.pre_get_game_server_deployment_rollout(request, metadata)
            pb_request = game_server_deployments.GetGameServerDeploymentRolloutRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListGameServerDeployments(GameServerDeploymentsServiceRestStub):
        ...
        deployments method over HTTP.
            ...
            request, metadata = self._interceptor.pre_list_game_server_deployments(request, metadata)
            pb_request = game_server_deployments.ListGameServerDeploymentsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _PreviewGameServerDeploymentRollout(GameServerDeploymentsServiceRestStub):
        ...
        deployment rollout method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1beta/{rollout.name=projects/*/locations/*/gameServerDeployments/*}/rollout:preview',
                'body': 'rollout',
            },
            ]
            request, metadata = self._interceptor.pre_preview_game_server_deployment_rollout(request, metadata)
            pb_request = game_server_deployments.PreviewGameServerDeploymentRolloutRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            ...
            pb_resp = game_server_deployments.PreviewGameServerDeploymentRolloutResponse.pb(resp)
    ...
    class _UpdateGameServerDeployment(GameServerDeploymentsServiceRestStub):
        ...
        deployment method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1beta/{game_server_deployment.name=projects/*/locations/*/gameServerDeployments/*}',
                'body': 'game_server_deployment',
            },
            ]
            request, metadata = self._interceptor.pre_update_game_server_deployment(request, metadata)
            pb_request = game_server_deployments.UpdateGameServerDeploymentRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _UpdateGameServerDeploymentRollout(GameServerDeploymentsServiceRestStub):
        ...
        deployment rollout method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1beta/{rollout.name=projects/*/locations/*/gameServerDeployments/*}/rollout',
                'body': 'rollout',
            },
            ]
            request, metadata = self._interceptor.pre_update_game_server_deployment_rollout(request, metadata)
            pb_request = game_server_deployments.UpdateGameServerDeploymentRolloutRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
