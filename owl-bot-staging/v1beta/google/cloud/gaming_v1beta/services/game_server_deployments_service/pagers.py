...
class ListGameServerDeploymentsPager:
    ...
    @property
    def pages(self) -> Iterator[game_server_deployments.ListGameServerDeploymentsResponse]:
...
class ListGameServerDeploymentsAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterator[game_server_deployments.ListGameServerDeploymentsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
