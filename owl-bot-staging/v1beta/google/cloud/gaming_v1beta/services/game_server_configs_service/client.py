...
from .transports.rest import GameServerConfigsServiceRestTransport
...
class GameServerConfigsServiceClientMeta(type):
    ...
    _transport_registry["rest"] = GameServerConfigsServiceRestTransport
...
class GameServerConfigsServiceClient(metaclass=GameServerConfigsServiceClientMeta):
    ...
    def transport(self) -> GameServerConfigsServiceTransport:
        ...
        Returns:
            GameServerConfigsServiceTransport: The transport used by the client
                instance.
        """
    ...
    def list_game_server_configs(self,
        ...
        Returns:
            google.cloud.gaming_v1beta.services.game_server_configs_service.pagers.ListGameServerConfigsPager:
