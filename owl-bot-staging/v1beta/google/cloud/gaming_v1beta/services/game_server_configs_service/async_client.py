...
class GameServerConfigsServiceAsyncClient:
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return GameServerConfigsServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    async def list_game_server_configs(self,
            request: Optional[Union[game_server_configs.ListGameServerConfigsRequest, dict]] = None,
            *,
        ...
        Args:
            request (Optional[Union[google.cloud.gaming_v1beta.types.ListGameServerConfigsRequest, dict]]):
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def get_game_server_config(self,
            request: Optional[Union[game_server_configs.GetGameServerConfigRequest, dict]] = None,
            *,
        ...
        Args:
            request (Optional[Union[google.cloud.gaming_v1beta.types.GetGameServerConfigRequest, dict]]):
                The request object. Request message for
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def create_game_server_config(self,
            request: Optional[Union[game_server_configs.CreateGameServerConfigRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        Args:
            request (Optional[Union[google.cloud.gaming_v1beta.types.CreateGameServerConfigRequest, dict]]):
                The request object. Request message for
    ...
    async def delete_game_server_config(self,
            request: Optional[Union[game_server_configs.DeleteGameServerConfigRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.gaming_v1beta.types.DeleteGameServerConfigRequest, dict]]):
                The request object. Request message for
