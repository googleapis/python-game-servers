...
from google.cloud.gaming_v1beta.services.game_server_configs_service import GameServerConfigsServiceAsyncClient
from google.cloud.gaming_v1beta.services.game_server_configs_service import GameServerConfigsServiceClient
...
def test_list_game_server_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*/gameServerDeployments/*}/configs" % client.transport._host, args[1])
...
def test_get_game_server_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/gameServerDeployments/*/configs/*}" % client.transport._host, args[1])
...
def test_game_server_configs_service_base_transport():
    ...
    with mock.patch('google.cloud.gaming_v1beta.services.game_server_configs_service.transports.GameServerConfigsServiceTransport.__init__') as Transport:
...
def test_game_server_configs_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.gaming_v1beta.services.game_server_configs_service.transports.GameServerConfigsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_game_server_configs_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.gaming_v1beta.services.game_server_configs_service.transports.GameServerConfigsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GameServerConfigsServiceTransport()
        adc.assert_called_once()
