...
from google.cloud.gaming_v1beta.services.game_server_configs_service.transports.base import _API_CORE_VERSION
from google.cloud.gaming_v1beta.services.game_server_configs_service.transports.base import _GOOGLE_AUTH_VERSION
