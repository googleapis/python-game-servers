...
class ListGameServerDeploymentsResponse(proto.Message):
    ...
    Attributes:
        game_server_deployments (MutableSequence[google.cloud.gaming_v1.types.GameServerDeployment]):
    ...
    game_server_deployments: MutableSequence['GameServerDeployment'] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
...
class FetchDeploymentStateResponse(proto.Message):
    ...
    class DeployedClusterState(proto.Message):
        ...
        Attributes:
            ...
            fleet_details (MutableSequence[google.cloud.gaming_v1.types.DeployedFleetDetails]):
        ...
        fleet_details: MutableSequence[common.DeployedFleetDetails] = proto.RepeatedField(
            proto.MESSAGE,
            number=2,
...
class GameServerDeploymentRollout(proto.Message):
    ...
    Attributes:
        ...
        game_server_config_overrides (MutableSequence[google.cloud.gaming_v1.types.GameServerConfigOverride]):
    ...
    game_server_config_overrides: MutableSequence['GameServerConfigOverride'] = proto.RepeatedField(
        proto.MESSAGE,
        number=5,
