...
class GameServerDeploymentsServiceClient(metaclass=GameServerDeploymentsServiceClientMeta):
    ...
    def list_game_server_deployments(self,
            request: Optional[Union[game_server_deployments.ListGameServerDeploymentsRequest, dict]] = None,
            *,
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_game_server_deployments]
    ...
    def get_game_server_deployment(self,
            request: Optional[Union[game_server_deployments.GetGameServerDeploymentRequest, dict]] = None,
            *,
        ...
        .. code-block:: python
            ...
            def sample_get_game_server_deployment():
                ...
                # Initialize request argument(s)
                request = gaming_v1.GetGameServerDeploymentRequest(
                    name="name_value",
                )
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_game_server_deployment]
    ...
    def create_game_server_deployment(self,
            request: Optional[Union[game_server_deployments.CreateGameServerDeploymentRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            game_server_deployment: Optional[game_server_deployments.GameServerDeployment] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Optional[float] = None,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> operation.Operation:
        ...
        .. code-block:: python
            ...
            def sample_create_game_server_deployment():
                ...
                # Initialize request argument(s)
                request = gaming_v1.CreateGameServerDeploymentRequest(
                    parent="parent_value",
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_game_server_deployment]
    ...
    def delete_game_server_deployment(self,
            request: Optional[Union[game_server_deployments.DeleteGameServerDeploymentRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Optional[float] = None,
        ...
        .. code-block:: python
            ...
            def sample_delete_game_server_deployment():
                ...
                # Initialize request argument(s)
                request = gaming_v1.DeleteGameServerDeploymentRequest(
                    name="name_value",
                )
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_game_server_deployment]
    ...
    def update_game_server_deployment(self,
            request: Optional[Union[game_server_deployments.UpdateGameServerDeploymentRequest, dict]] = None,
            *,
            game_server_deployment: Optional[game_server_deployments.GameServerDeployment] = None,
        ...
        .. code-block:: python
            ...
            def sample_update_game_server_deployment():
                ...
                # Initialize request argument(s)
                request = gaming_v1.UpdateGameServerDeploymentRequest(
                )
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_game_server_deployment]
    ...
    def get_game_server_deployment_rollout(self,
            request: Optional[Union[game_server_deployments.GetGameServerDeploymentRolloutRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Optional[float] = None,
        ...
        .. code-block:: python
            ...
            def sample_get_game_server_deployment_rollout():
                ...
                # Initialize request argument(s)
                request = gaming_v1.GetGameServerDeploymentRolloutRequest(
                    name="name_value",
                )
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_game_server_deployment_rollout]
    ...
    def update_game_server_deployment_rollout(self,
            request: Optional[Union[game_server_deployments.UpdateGameServerDeploymentRolloutRequest, dict]] = None,
            *,
        ...
        .. code-block:: python
            ...
            def sample_update_game_server_deployment_rollout():
                ...
                # Initialize request argument(s)
                request = gaming_v1.UpdateGameServerDeploymentRolloutRequest(
                )
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_game_server_deployment_rollout]
    ...
    def preview_game_server_deployment_rollout(self,
            request: Optional[Union[game_server_deployments.PreviewGameServerDeploymentRolloutRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Optional[float] = None,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, game_server_deployments.PreviewGameServerDeploymentRolloutRequest):
            request = game_server_deployments.PreviewGameServerDeploymentRolloutRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.preview_game_server_deployment_rollout]
    ...
    def fetch_deployment_state(self,
            request: Optional[Union[game_server_deployments.FetchDeploymentStateRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Optional[float] = None,
            metadata: Sequence[Tuple[str, str]] = (),
