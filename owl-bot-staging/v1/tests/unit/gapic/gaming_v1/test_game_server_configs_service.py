...
from google.cloud.gaming_v1.services.game_server_configs_service import GameServerConfigsServiceAsyncClient
from google.cloud.gaming_v1.services.game_server_configs_service import GameServerConfigsServiceClient
...
def test__get_default_mtls_endpoint():
    ...
    assert GameServerConfigsServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert GameServerConfigsServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert GameServerConfigsServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert GameServerConfigsServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test_game_server_configs_service_client_from_service_account_info(client_class, transport_name):
...
def test_game_server_configs_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_game_server_configs_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (GameServerConfigsServiceClient, transports.GameServerConfigsServiceGrpcTransport, "grpc"),
    (GameServerConfigsServiceAsyncClient, transports.GameServerConfigsServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (GameServerConfigsServiceClient, transports.GameServerConfigsServiceRestTransport, "rest"),
])
@mock.patch.object(GameServerConfigsServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GameServerConfigsServiceClient))
@mock.patch.object(GameServerConfigsServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GameServerConfigsServiceAsyncClient))
def test_game_server_configs_service_client_client_options(client_class, transport_class, transport_name):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(GameServerConfigsServiceClient, 'get_transport_class') as gtc:
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (GameServerConfigsServiceClient, transports.GameServerConfigsServiceGrpcTransport, "grpc", "true"),
    (GameServerConfigsServiceAsyncClient, transports.GameServerConfigsServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (GameServerConfigsServiceClient, transports.GameServerConfigsServiceGrpcTransport, "grpc", "false"),
    (GameServerConfigsServiceAsyncClient, transports.GameServerConfigsServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (GameServerConfigsServiceClient, transports.GameServerConfigsServiceRestTransport, "rest", "true"),
    (GameServerConfigsServiceClient, transports.GameServerConfigsServiceRestTransport, "rest", "false"),
])
@mock.patch.object(GameServerConfigsServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GameServerConfigsServiceClient))
@mock.patch.object(GameServerConfigsServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GameServerConfigsServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_game_server_configs_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(GameServerConfigsServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GameServerConfigsServiceClient))
@mock.patch.object(GameServerConfigsServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GameServerConfigsServiceAsyncClient))
def test_game_server_configs_service_client_get_mtls_endpoint_and_cert_source(client_class):
...
def test_game_server_configs_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (GameServerConfigsServiceClient, transports.GameServerConfigsServiceGrpcTransport, "grpc", grpc_helpers),
    (GameServerConfigsServiceAsyncClient, transports.GameServerConfigsServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (GameServerConfigsServiceClient, transports.GameServerConfigsServiceRestTransport, "rest", None),
])
def test_game_server_configs_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_game_server_configs_service_client_client_options_from_dict():
    with mock.patch('google.cloud.gaming_v1.services.game_server_configs_service.transports.GameServerConfigsServiceGrpcTransport.__init__') as grpc_transport:
...
def test_game_server_configs_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
async def test_list_game_server_configs_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_game_server_configs(
            parent='parent_value',
        )
...
async def test_list_game_server_configs_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_game_server_configs(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_get_game_server_config_async(transport: str = 'grpc_asyncio', request_type=game_server_configs.GetGameServerConfigRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(game_server_configs.GameServerConfig(
            name='name_value',
            description='description_value',
        ))
...
async def test_get_game_server_config_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.get_game_server_config(
            name='name_value',
        )
...
def test_create_game_server_config_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = 'parent_value'
        assert arg == mock_val
        arg = args[0].game_server_config
        mock_val = game_server_configs.GameServerConfig(name='name_value')
        assert arg == mock_val
...
async def test_delete_game_server_config_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_game_server_config(
            name='name_value',
        )
...
def test_list_game_server_configs_rest(request_type):
    ...
    request_init = {'parent': 'projects/sample1/locations/sample2/gameServerDeployments/sample3'}
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = game_server_configs.ListGameServerConfigsResponse.pb(return_value)
...
def test_list_game_server_configs_rest_required_fields(request_type=game_server_configs.ListGameServerConfigsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_game_server_configs._get_unset_required_fields(jsonified_request)
...
def test_list_game_server_configs_rest_unset_required_fields():
    transport = transports.GameServerConfigsServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_game_server_configs_rest_interceptors(null_interceptor):
    transport = transports.GameServerConfigsServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.GameServerConfigsServiceRestInterceptor(),
        )
    client = GameServerConfigsServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GameServerConfigsServiceRestInterceptor, "post_list_game_server_configs") as post, \
         mock.patch.object(transports.GameServerConfigsServiceRestInterceptor, "pre_list_game_server_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_configs.ListGameServerConfigsRequest.pb(game_server_configs.ListGameServerConfigsRequest())
        ...
        req.return_value._content = game_server_configs.ListGameServerConfigsResponse.to_json(game_server_configs.ListGameServerConfigsResponse())
        ...
        client.list_game_server_configs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_game_server_configs_rest_bad_request(transport: str = 'rest', request_type=game_server_configs.ListGameServerConfigsRequest):
    client = GameServerConfigsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_game_server_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        sample_request = {'parent': 'projects/sample1/locations/sample2/gameServerDeployments/sample3'}
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/gameServerDeployments/*}/configs" % client.transport._host, args[1])
...
def test_list_game_server_configs_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(game_server_configs.ListGameServerConfigsResponse.to_json(x) for x in response)
...
def test_get_game_server_config_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/gameServerDeployments/sample3/configs/sample4'}
    request = request_type(**request_init)
...
def test_get_game_server_config_rest_required_fields(request_type=game_server_configs.GetGameServerConfigRequest):
    transport_class = transports.GameServerConfigsServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_game_server_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_game_server_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GameServerConfigsServiceRestInterceptor, "post_get_game_server_config") as post, \
         mock.patch.object(transports.GameServerConfigsServiceRestInterceptor, "pre_get_game_server_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_configs.GetGameServerConfigRequest.pb(game_server_configs.GetGameServerConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = game_server_configs.GameServerConfig.to_json(game_server_configs.GameServerConfig())
        ...
        client.get_game_server_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_game_server_config_rest_bad_request(transport: str = 'rest', request_type=game_server_configs.GetGameServerConfigRequest):
    client = GameServerConfigsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_game_server_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/gameServerDeployments/sample3/configs/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/gameServerDeployments/*/configs/*}" % client.transport._host, args[1])
...
def test_create_game_server_config_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/gameServerDeployments/sample3'}
    request_init["game_server_config"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'fleet_configs': [{'fleet_spec': 'fleet_spec_value', 'name': 'name_value'}], 'scaling_configs': [{'name': 'name_value', 'fleet_autoscaler_spec': 'fleet_autoscaler_spec_value', 'selectors': [{'labels': {}}], 'schedules': [{'start_time': {}, 'end_time': {}, 'cron_job_duration': {'seconds': 751, 'nanos': 543}, 'cron_spec': 'cron_spec_value'}]}], 'description': 'description_value'}
    request = request_type(**request_init)
...
def test_create_game_server_config_rest_required_fields(request_type=game_server_configs.CreateGameServerConfigRequest):
    transport_class = transports.GameServerConfigsServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_game_server_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_game_server_config_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("configId", )) & set(("parent", "configId", "gameServerConfig", )))
...
def test_create_game_server_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.GameServerConfigsServiceRestInterceptor, "post_create_game_server_config") as post, \
         mock.patch.object(transports.GameServerConfigsServiceRestInterceptor, "pre_create_game_server_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_configs.CreateGameServerConfigRequest.pb(game_server_configs.CreateGameServerConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_game_server_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_game_server_config_rest_bad_request(transport: str = 'rest', request_type=game_server_configs.CreateGameServerConfigRequest):
    client = GameServerConfigsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_game_server_config_rest_required_fields(request_type=game_server_configs.DeleteGameServerConfigRequest):
    transport_class = transports.GameServerConfigsServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_game_server_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_game_server_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.GameServerConfigsServiceRestInterceptor, "post_delete_game_server_config") as post, \
         mock.patch.object(transports.GameServerConfigsServiceRestInterceptor, "pre_delete_game_server_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_configs.DeleteGameServerConfigRequest.pb(game_server_configs.DeleteGameServerConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_game_server_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_game_server_config_rest_bad_request(transport: str = 'rest', request_type=game_server_configs.DeleteGameServerConfigRequest):
    client = GameServerConfigsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_transport_kind(transport_name):
    transport = GameServerConfigsServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_game_server_configs_service_base_transport():
    ...
    with mock.patch('google.cloud.gaming_v1.services.game_server_configs_service.transports.GameServerConfigsServiceTransport.__init__') as Transport:
...
def test_game_server_configs_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.gaming_v1.services.game_server_configs_service.transports.GameServerConfigsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_game_server_configs_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.gaming_v1.services.game_server_configs_service.transports.GameServerConfigsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GameServerConfigsServiceTransport()
        adc.assert_called_once()
...
def test_game_server_configs_service_transport_auth_adc(transport_class):
...
@pytest.mark.parametrize(
    ...
    [
        (transports.GameServerConfigsServiceGrpcTransport, grpc_helpers),
        (transports.GameServerConfigsServiceGrpcAsyncIOTransport, grpc_helpers_async)
    ],
)
def test_game_server_configs_service_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
@pytest.mark.parametrize("transport_class", [transports.GameServerConfigsServiceGrpcTransport, transports.GameServerConfigsServiceGrpcAsyncIOTransport])
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.GameServerConfigsServiceGrpcTransport, transports.GameServerConfigsServiceGrpcAsyncIOTransport])
def test_game_server_configs_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_game_server_config_path():
    ...
    deployment = "whelk"
    config = "octopus"
    expected = "projects/{project}/locations/{location}/gameServerDeployments/{deployment}/configs/{config}".format(project=project, location=location, deployment=deployment, config=config, )
    actual = GameServerConfigsServiceClient.game_server_config_path(project, location, deployment, config)
...
@pytest.mark.parametrize("client_class,transport_class", [
    (GameServerConfigsServiceClient, transports.GameServerConfigsServiceGrpcTransport),
    (GameServerConfigsServiceAsyncClient, transports.GameServerConfigsServiceGrpcAsyncIOTransport),
])
