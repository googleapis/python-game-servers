...
from google.cloud.gaming_v1.services.game_server_clusters_service import GameServerClustersServiceAsyncClient
from google.cloud.gaming_v1.services.game_server_clusters_service import GameServerClustersServiceClient
...
def test_game_server_clusters_service_client_from_service_account_info(client_class, transport_name):
...
def test_game_server_clusters_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_game_server_clusters_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (GameServerClustersServiceClient, transports.GameServerClustersServiceRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (GameServerClustersServiceClient, transports.GameServerClustersServiceGrpcTransport, "grpc", "true"),
    (GameServerClustersServiceAsyncClient, transports.GameServerClustersServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (GameServerClustersServiceClient, transports.GameServerClustersServiceGrpcTransport, "grpc", "false"),
    (GameServerClustersServiceAsyncClient, transports.GameServerClustersServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (GameServerClustersServiceClient, transports.GameServerClustersServiceRestTransport, "rest", "true"),
    (GameServerClustersServiceClient, transports.GameServerClustersServiceRestTransport, "rest", "false"),
])
@mock.patch.object(GameServerClustersServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GameServerClustersServiceClient))
@mock.patch.object(GameServerClustersServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GameServerClustersServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_game_server_clusters_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(GameServerClustersServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GameServerClustersServiceClient))
@mock.patch.object(GameServerClustersServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GameServerClustersServiceAsyncClient))
def test_game_server_clusters_service_client_get_mtls_endpoint_and_cert_source(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (GameServerClustersServiceClient, transports.GameServerClustersServiceGrpcTransport, "grpc", grpc_helpers),
    (GameServerClustersServiceAsyncClient, transports.GameServerClustersServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (GameServerClustersServiceClient, transports.GameServerClustersServiceRestTransport, "rest", None),
])
def test_game_server_clusters_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_game_server_clusters_service_client_client_options_from_dict():
    with mock.patch('google.cloud.gaming_v1.services.game_server_clusters_service.transports.GameServerClustersServiceGrpcTransport.__init__') as grpc_transport:
...
def test_game_server_clusters_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
@pytest.mark.asyncio
async def test_list_game_server_clusters_async(transport: str = 'grpc_asyncio', request_type=game_server_clusters.ListGameServerClustersRequest):
...
async def test_list_game_server_clusters_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_game_server_clusters(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_game_server_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_game_server_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_game_server_cluster_async(transport: str = 'grpc_asyncio', request_type=game_server_clusters.GetGameServerClusterRequest):
    client = GameServerClustersServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_game_server_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_game_server_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_game_server_cluster_async(transport: str = 'grpc_asyncio', request_type=game_server_clusters.CreateGameServerClusterRequest):
    client = GameServerClustersServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_preview_create_game_server_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.preview_create_game_server_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_preview_create_game_server_cluster_async(transport: str = 'grpc_asyncio', request_type=game_server_clusters.PreviewCreateGameServerClusterRequest):
    client = GameServerClustersServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_game_server_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_game_server_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_game_server_cluster_async(transport: str = 'grpc_asyncio', request_type=game_server_clusters.DeleteGameServerClusterRequest):
    client = GameServerClustersServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_preview_delete_game_server_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.preview_delete_game_server_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_preview_delete_game_server_cluster_async(transport: str = 'grpc_asyncio', request_type=game_server_clusters.PreviewDeleteGameServerClusterRequest):
    client = GameServerClustersServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_game_server_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_game_server_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_update_game_server_cluster_async(transport: str = 'grpc_asyncio', request_type=game_server_clusters.UpdateGameServerClusterRequest):
    client = GameServerClustersServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_preview_update_game_server_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.preview_update_game_server_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_preview_update_game_server_cluster_async(transport: str = 'grpc_asyncio', request_type=game_server_clusters.PreviewUpdateGameServerClusterRequest):
    client = GameServerClustersServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_game_server_clusters_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = game_server_clusters.ListGameServerClustersResponse.pb(return_value)
...
def test_list_game_server_clusters_rest_required_fields(request_type=game_server_clusters.ListGameServerClustersRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_game_server_clusters._get_unset_required_fields(jsonified_request)
...
def test_list_game_server_clusters_rest_unset_required_fields():
    transport = transports.GameServerClustersServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_game_server_clusters_rest_interceptors(null_interceptor):
    transport = transports.GameServerClustersServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.GameServerClustersServiceRestInterceptor(),
        )
    client = GameServerClustersServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GameServerClustersServiceRestInterceptor, "post_list_game_server_clusters") as post, \
         mock.patch.object(transports.GameServerClustersServiceRestInterceptor, "pre_list_game_server_clusters") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_clusters.ListGameServerClustersRequest.pb(game_server_clusters.ListGameServerClustersRequest())
        ...
        req.return_value._content = game_server_clusters.ListGameServerClustersResponse.to_json(game_server_clusters.ListGameServerClustersResponse())
        ...
        client.list_game_server_clusters(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_game_server_clusters_rest_bad_request(transport: str = 'rest', request_type=game_server_clusters.ListGameServerClustersRequest):
    client = GameServerClustersServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_game_server_clusters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/realms/*}/gameServerClusters" % client.transport._host, args[1])
...
def test_list_game_server_clusters_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(game_server_clusters.ListGameServerClustersResponse.to_json(x) for x in response)
...
def test_get_game_server_cluster_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/realms/sample3/gameServerClusters/sample4'}
    request = request_type(**request_init)
...
def test_get_game_server_cluster_rest_required_fields(request_type=game_server_clusters.GetGameServerClusterRequest):
    transport_class = transports.GameServerClustersServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_game_server_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_game_server_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GameServerClustersServiceRestInterceptor, "post_get_game_server_cluster") as post, \
         mock.patch.object(transports.GameServerClustersServiceRestInterceptor, "pre_get_game_server_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_clusters.GetGameServerClusterRequest.pb(game_server_clusters.GetGameServerClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = game_server_clusters.GameServerCluster.to_json(game_server_clusters.GameServerCluster())
        ...
        client.get_game_server_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_game_server_cluster_rest_bad_request(transport: str = 'rest', request_type=game_server_clusters.GetGameServerClusterRequest):
    client = GameServerClustersServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_game_server_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/realms/sample3/gameServerClusters/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/realms/*/gameServerClusters/*}" % client.transport._host, args[1])
...
def test_create_game_server_cluster_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/realms/sample3'}
    request_init["game_server_cluster"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'connection_info': {'gke_cluster_reference': {'cluster': 'cluster_value'}, 'namespace': 'namespace_value'}, 'etag': 'etag_value', 'description': 'description_value', 'cluster_state': {'agones_version_installed': 'agones_version_installed_value', 'kubernetes_version_installed': 'kubernetes_version_installed_value', 'installation_state': 1, 'version_installed_error_message': 'version_installed_error_message_value', 'provider': 'provider_value', 'agones_version_targeted': 'agones_version_targeted_value'}}
    request = request_type(**request_init)
...
def test_create_game_server_cluster_rest_required_fields(request_type=game_server_clusters.CreateGameServerClusterRequest):
    transport_class = transports.GameServerClustersServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_game_server_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present
    assert "gameServerClusterId" in jsonified_request
    assert jsonified_request["gameServerClusterId"] == request_init["game_server_cluster_id"]
...
def test_create_game_server_cluster_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("gameServerClusterId", )) & set(("parent", "gameServerClusterId", "gameServerCluster", )))
...
def test_create_game_server_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.GameServerClustersServiceRestInterceptor, "post_create_game_server_cluster") as post, \
         mock.patch.object(transports.GameServerClustersServiceRestInterceptor, "pre_create_game_server_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_clusters.CreateGameServerClusterRequest.pb(game_server_clusters.CreateGameServerClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_game_server_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_game_server_cluster_rest_bad_request(transport: str = 'rest', request_type=game_server_clusters.CreateGameServerClusterRequest):
    client = GameServerClustersServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_preview_create_game_server_cluster_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = game_server_clusters.PreviewCreateGameServerClusterResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_preview_create_game_server_cluster_rest_required_fields(request_type=game_server_clusters.PreviewCreateGameServerClusterRequest):
    transport_class = transports.GameServerClustersServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).preview_create_game_server_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).preview_create_game_server_cluster._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("game_server_cluster_id", "preview_time", "view", ))
    jsonified_request.update(unset_fields)
...
def test_preview_create_game_server_cluster_rest_unset_required_fields():
    ...
    unset_fields = transport.preview_create_game_server_cluster._get_unset_required_fields({})
    assert set(unset_fields) == (set(("gameServerClusterId", "previewTime", "view", )) & set(("parent", "gameServerClusterId", "gameServerCluster", )))
...
def test_preview_create_game_server_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GameServerClustersServiceRestInterceptor, "post_preview_create_game_server_cluster") as post, \
         mock.patch.object(transports.GameServerClustersServiceRestInterceptor, "pre_preview_create_game_server_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_clusters.PreviewCreateGameServerClusterRequest.pb(game_server_clusters.PreviewCreateGameServerClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = game_server_clusters.PreviewCreateGameServerClusterResponse.to_json(game_server_clusters.PreviewCreateGameServerClusterResponse())
        ...
        pre.return_value = request, metadata
        post.return_value = game_server_clusters.PreviewCreateGameServerClusterResponse()

        client.preview_create_game_server_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_preview_create_game_server_cluster_rest_bad_request(transport: str = 'rest', request_type=game_server_clusters.PreviewCreateGameServerClusterRequest):
    client = GameServerClustersServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_game_server_cluster_rest_required_fields(request_type=game_server_clusters.DeleteGameServerClusterRequest):
    transport_class = transports.GameServerClustersServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_game_server_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_game_server_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.GameServerClustersServiceRestInterceptor, "post_delete_game_server_cluster") as post, \
         mock.patch.object(transports.GameServerClustersServiceRestInterceptor, "pre_delete_game_server_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_clusters.DeleteGameServerClusterRequest.pb(game_server_clusters.DeleteGameServerClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_game_server_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_game_server_cluster_rest_bad_request(transport: str = 'rest', request_type=game_server_clusters.DeleteGameServerClusterRequest):
    client = GameServerClustersServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_preview_delete_game_server_cluster_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = game_server_clusters.PreviewDeleteGameServerClusterResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_preview_delete_game_server_cluster_rest_required_fields(request_type=game_server_clusters.PreviewDeleteGameServerClusterRequest):
    transport_class = transports.GameServerClustersServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).preview_delete_game_server_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_preview_delete_game_server_cluster_rest_unset_required_fields():
    ...
    unset_fields = transport.preview_delete_game_server_cluster._get_unset_required_fields({})
...
def test_preview_delete_game_server_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GameServerClustersServiceRestInterceptor, "post_preview_delete_game_server_cluster") as post, \
         mock.patch.object(transports.GameServerClustersServiceRestInterceptor, "pre_preview_delete_game_server_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_clusters.PreviewDeleteGameServerClusterRequest.pb(game_server_clusters.PreviewDeleteGameServerClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = game_server_clusters.PreviewDeleteGameServerClusterResponse.to_json(game_server_clusters.PreviewDeleteGameServerClusterResponse())
        ...
        pre.return_value = request, metadata
        post.return_value = game_server_clusters.PreviewDeleteGameServerClusterResponse()

        client.preview_delete_game_server_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_preview_delete_game_server_cluster_rest_bad_request(transport: str = 'rest', request_type=game_server_clusters.PreviewDeleteGameServerClusterRequest):
    client = GameServerClustersServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_game_server_cluster_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'game_server_cluster': {'name': 'projects/sample1/locations/sample2/realms/sample3/gameServerClusters/sample4'}}
    request_init["game_server_cluster"] = {'name': 'projects/sample1/locations/sample2/realms/sample3/gameServerClusters/sample4', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'connection_info': {'gke_cluster_reference': {'cluster': 'cluster_value'}, 'namespace': 'namespace_value'}, 'etag': 'etag_value', 'description': 'description_value', 'cluster_state': {'agones_version_installed': 'agones_version_installed_value', 'kubernetes_version_installed': 'kubernetes_version_installed_value', 'installation_state': 1, 'version_installed_error_message': 'version_installed_error_message_value', 'provider': 'provider_value', 'agones_version_targeted': 'agones_version_targeted_value'}}
    request = request_type(**request_init)
...
def test_update_game_server_cluster_rest_required_fields(request_type=game_server_clusters.UpdateGameServerClusterRequest):
    transport_class = transports.GameServerClustersServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_game_server_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_game_server_cluster_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("gameServerCluster", "updateMask", )))
...
def test_update_game_server_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.GameServerClustersServiceRestInterceptor, "post_update_game_server_cluster") as post, \
         mock.patch.object(transports.GameServerClustersServiceRestInterceptor, "pre_update_game_server_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_clusters.UpdateGameServerClusterRequest.pb(game_server_clusters.UpdateGameServerClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_game_server_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_game_server_cluster_rest_bad_request(transport: str = 'rest', request_type=game_server_clusters.UpdateGameServerClusterRequest):
    client = GameServerClustersServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_game_server_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'game_server_cluster': {'name': 'projects/sample1/locations/sample2/realms/sample3/gameServerClusters/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{game_server_cluster.name=projects/*/locations/*/realms/*/gameServerClusters/*}" % client.transport._host, args[1])
...
def test_preview_update_game_server_cluster_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = game_server_clusters.PreviewUpdateGameServerClusterResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_preview_update_game_server_cluster_rest_required_fields(request_type=game_server_clusters.PreviewUpdateGameServerClusterRequest):
    transport_class = transports.GameServerClustersServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).preview_update_game_server_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_preview_update_game_server_cluster_rest_unset_required_fields():
    ...
    unset_fields = transport.preview_update_game_server_cluster._get_unset_required_fields({})
    assert set(unset_fields) == (set(("previewTime", "updateMask", )) & set(("gameServerCluster", "updateMask", )))
...
def test_preview_update_game_server_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GameServerClustersServiceRestInterceptor, "post_preview_update_game_server_cluster") as post, \
         mock.patch.object(transports.GameServerClustersServiceRestInterceptor, "pre_preview_update_game_server_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = game_server_clusters.PreviewUpdateGameServerClusterRequest.pb(game_server_clusters.PreviewUpdateGameServerClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = game_server_clusters.PreviewUpdateGameServerClusterResponse.to_json(game_server_clusters.PreviewUpdateGameServerClusterResponse())
        ...
        pre.return_value = request, metadata
        post.return_value = game_server_clusters.PreviewUpdateGameServerClusterResponse()

        client.preview_update_game_server_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_preview_update_game_server_cluster_rest_bad_request(transport: str = 'rest', request_type=game_server_clusters.PreviewUpdateGameServerClusterRequest):
    client = GameServerClustersServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_transport_kind(transport_name):
    transport = GameServerClustersServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_game_server_clusters_service_base_transport():
    ...
    with mock.patch('google.cloud.gaming_v1.services.game_server_clusters_service.transports.GameServerClustersServiceTransport.__init__') as Transport:
...
def test_game_server_clusters_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.gaming_v1.services.game_server_clusters_service.transports.GameServerClustersServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_game_server_clusters_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.gaming_v1.services.game_server_clusters_service.transports.GameServerClustersServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GameServerClustersServiceTransport()
        adc.assert_called_once()
...
def test_game_server_clusters_service_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
@pytest.mark.parametrize("transport_class", [transports.GameServerClustersServiceGrpcTransport, transports.GameServerClustersServiceGrpcAsyncIOTransport])
...
def test_game_server_clusters_service_client_transport_session_collision(transport_name):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.GameServerClustersServiceGrpcTransport, transports.GameServerClustersServiceGrpcAsyncIOTransport])
def test_game_server_clusters_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_common_billing_account_path():
    ...
    actual = GameServerClustersServiceClient.common_billing_account_path(billing_account)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.GameServerClustersServiceTransport, '_prep_wrapped_messages') as prep:
        client = GameServerClustersServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.parametrize("client_class,transport_class", [
    (GameServerClustersServiceClient, transports.GameServerClustersServiceGrpcTransport),
    (GameServerClustersServiceAsyncClient, transports.GameServerClustersServiceGrpcAsyncIOTransport),
])
