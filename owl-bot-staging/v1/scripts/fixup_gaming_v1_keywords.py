...
class gamingCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
          ...
          'get_game_server_cluster': ('name', 'view', ),
          'get_game_server_config': ('name', ),
          'get_game_server_deployment': ('name', ),
          'get_game_server_deployment_rollout': ('name', ),
          'get_realm': ('name', ),
          'list_game_server_clusters': ('parent', 'page_size', 'page_token', 'filter', 'order_by', 'view', ),
          ...
          'preview_create_game_server_cluster': ('parent', 'game_server_cluster_id', 'game_server_cluster', 'preview_time', 'view', ),
...
def fix_files(
    ...
    *,
    transformer=gamingCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the gaming client library.
