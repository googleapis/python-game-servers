...
"""Google Cloud Game Servers sample for updating a realm.

Example usage:
    python update_realm.py --project-id <project-id> --location <location> --realm-id <realm-id>
"""
...
if __name__ == "__main__":
    ...
    update_realm(args.project_id, args.location, args.realm_id)
