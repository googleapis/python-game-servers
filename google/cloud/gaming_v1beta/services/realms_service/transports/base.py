    ...
    def _prep_wrapped_messages(self):
        ...
        self._wrapped_methods = {
            self.list_realms: gapic_v1.method.wrap_method(
                self.list_realms, default_timeout=None, client_info=_client_info,
            ),
            self.get_realm: gapic_v1.method.wrap_method(
                self.get_realm, default_timeout=None, client_info=_client_info,
            ),
            self.create_realm: gapic_v1.method.wrap_method(
                self.create_realm, default_timeout=None, client_info=_client_info,
            ),
            self.delete_realm: gapic_v1.method.wrap_method(
                self.delete_realm, default_timeout=None, client_info=_client_info,
            ),
            self.update_realm: gapic_v1.method.wrap_method(
                self.update_realm, default_timeout=None, client_info=_client_info,
            ),
