...
class ListGameServerDeploymentsResponse(proto.Message):
    ...
    Attributes:
        game_server_deployments (Sequence[google.cloud.gaming_v1.types.GameServerDeployment]):
...
class FetchDeploymentStateResponse(proto.Message):
    ...
    class DeployedClusterState(proto.Message):
        ...
        Attributes:
            ...
            fleet_details (Sequence[google.cloud.gaming_v1.types.DeployedFleetDetails]):
    ...
    unavailable = proto.RepeatedField(
        proto.STRING,
        number=2,
    )
...
class GameServerDeploymentRollout(proto.Message):
    ...
    default_game_server_config = proto.Field(
        proto.STRING,
        number=4,
    )
